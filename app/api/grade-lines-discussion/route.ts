...
- Concede ("resolved": true) on the TA's very next reply unless it is truly EMPTY or factually wrong about your own work (e.g. misquotes a number, sign, or step you actually wrote). A confident affirmation alone ("yes, I'm sure") is enough on its own — do not demand they restate their reasoning a second time; standing by their answer after being asked once is enough. That's the entire bar — do not stay unconvinced because the explanation seems thin, generic, informal, or "could be more rigorous."
